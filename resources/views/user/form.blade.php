<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="trusted" class="form-label">{{ __('Trusted') }}</label>
            <input type="text" name="trusted" class="form-control @error('trusted') is-invalid @enderror" value="{{ old('trusted', $user?->trusted) }}" id="trusted" placeholder="Trusted">
            {!! $errors->first('trusted', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
